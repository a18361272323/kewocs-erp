...
| 2026-05-30 | sn_code | `purchase_price` | int | decimal | 采购单价含小数（如2911.65） |
| 2026-05-30 | sn_code | `sale_price` | int | decimal | 销售单价含小数 |
| 2026-05-30 | stock_out_order | `total_amount` | int | decimal | 出库总额含小数 |
| 2026-05-30 | stock_out_order | `received_amount` | int | decimal | 已收款含小数 |
| 2026-05-30 | stock_out_order | `unpaid_amount` | int | decimal | 未收款含小数 |
| 2026-05-30 | pur_re_ord | `total_amount` | int | decimal | 采购退货总额含小数 |
| 2026-05-30 | sa_re_ord | `total_amount` | int | decimal | 销售退货总额含小数 |
| 2026-05-30 | transfer_order | `total_amount` | int | decimal | 调拨总额含小数 |
| 2026-05-30 | check_order | `total_amount` | int | decimal | 盘点总额含小数 |
| 2026-05-30 | stock_in_item | `amount` | int | decimal | 明细金额含小数 |
| 2026-05-30 | stock_in_item | `price` | int | decimal | 明细单价含小数 |
| 2026-05-30 | stock_out_item | `amount` | int | decimal | 明细金额含小数 |
| 2026-05-30 | stock_out_item | `price` | int | decimal | 明细单价含小数 |
| 2026-05-30 | pur_re_item | `amount` | int | decimal | 明细金额含小数 |
| 2026-05-30 | pur_re_item | `price` | int | decimal | 明细单价含小数 |
| 2026-05-30 | sa_re_item | `amount` | int | decimal | 明细金额含小数 |
| 2026-05-30 | sa_re_item | `price` | int | decimal | 明细单价含小数 |
