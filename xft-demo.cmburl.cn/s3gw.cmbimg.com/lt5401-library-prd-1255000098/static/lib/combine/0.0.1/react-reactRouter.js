//static/lib/react/18.2.0/umd/react.production.min.js
/**
 *
 * @license React
...
//static/lib/react-dom/18.2.0/umd/react-dom.production.min.js
/**
 * @license React
...
//static/lib/@remix-run/router/1.0.3/dist/router.umd.min.js
/**
...
!(function (e, t) {
  ...
  function c(e) {
    let t =
        ...
        'null' !== window.location.origin
          ...
          : 'unknown://unknown',
      r = 'string' == typeof e ? e : s(e);
    return new URL(r, t);
  }
  function d(r, n, l, d) {
    void 0 === d && (d = {});
    let { window: u = document.defaultView, v5Compat: h = !1 } = d,
      f = u.history,
      p = e.Action.Pop,
      m = null;
    function g() {
      (p = e.Action.Pop), m && m({ action: p, location: v.location });
    }
    let v = {
      get action() {
        return p;
      ...
      listen(e) {
        ...
        return (
          ...
          (m = e),
          () => {
            u.removeEventListener(a, g), (m = null);
          }
        );
      },
      createHref: (e) => n(u, e),
      ...
      push: function (t, r) {
        ...
        h && m && m({ action: p, location: v.location });
      },
  ...
  function h(e, r, a) {
    return (
      ...
      e.map((e, n) => {
        ...
        return t({}, e, {
          id: i,
          children: e.children ? h(e.children, o, a) : void 0,
        });
      })
    );
  }
  function f(e, t, r) {
    void 0 === r && (r = '/');
    let a = D(('string' == typeof t ? l(t) : t).pathname || '/', r);
    if (null == a) return null;
    let n = p(e);
    !(function (e) {
      e.sort((e, t) =>
    ...
    let o = null;
    for (let e = 0; null == o && e < n.length; ++e) o = y(n[e], b(a));
    return o;
  }
  function p(e, t, r, a) {
    return (
      ...
      e.forEach((e, n) => {
        ...
        e.children &&
          ...
          p(e.children, t, s, i)),
          (null != e.path || e.index) &&
            t.push({ path: i, score: v(i, e.index), routesMeta: s });
      }),
      t
    );
  }
  ...
  function v(e, t) {
    ...
    return (
      ...
      r
        .filter((e) => !g(e))
        .reduce((e, t) => e + (m.test(t) ? 3 : '' === t ? 1 : 10), a)
    );
  }
  function y(e, t) {
    let { routesMeta: r } = e,
    ...
    for (let e = 0; e < r.length; ++e) {
      ...
      o.push({
        params: a,
        pathname: S([n, c.pathname]),
        pathnameBase: C(S([n, c.pathnameBase])),
        route: d,
      }),
        '/' !== c.pathnameBase && (n = S([n, c.pathnameBase]));
    }
    return o;
  }
  function w(e, t) {
    ...
    let [r, a] = (function (e, t, r) {
        ...
        e.endsWith('*')
          ...
          ? (n += '\\/*$')
          : '' !== e && '/' !== e && (n += '(?:(?=\\/|$))');
        return [new RegExp(n, t ? void 0 : 'i'), a];
  ...
  function R(e, t) {
    ...
    let {
      ...
      o = r
        ...
        : t;
    return { pathname: o, search: T(a), hash: j(n) };
  }
  function P(e, t, r, a) {
    return (
      "Cannot include a '" +
    ...
    void 0 === n && (n = !1),
      'string' == typeof e
        ...
        : ((o = t({}, e)),
          ...
          E(!o.search || !o.search.includes('#'), P('#', 'search', 'hash', o)));
    let i,
      s = '' === e || '' === o.pathname,
      c = s ? '/' : o.pathname;
    if (n || null == c) i = a;
  ...
  class O {
    constructor(e) {
      ...
      (this.pendingKeys = new Set()),
        ...
        (this.abortPromise = new Promise((e, r) => (t = r))),
        (this.controller = new AbortController());
      let r = () => t(new L('Deferred data aborted'));
    ...
    onSettle(e, t, r, a) {
      if (this.controller.signal.aborted && r instanceof L)
        return (
          this.unlistenAbortSignal(),
      ...
      const n = this.subscriber;
      return r
        ? (Object.defineProperty(e, '_error', { get: () => r }),
          n && n(!1),
          Promise.reject(r))
        : (Object.defineProperty(e, '_data', { get: () => a }), n && n(!1), a);
    }
    subscribe(e) {
      this.subscriber = e;
    }
  ...
  const $ = new Set(['POST', 'PUT', 'PATCH', 'DELETE']),
    q = new Set(['GET', 'HEAD', ...$]);
  function F(e, t, r) {
    void 0 === r && (r = !1);
    let a = 'string' == typeof e ? e : s(e);
    if (!t || (!('formMethod' in t) && !('formData' in t))) return { path: a };
    ...
    if (!t.formData) return { path: a };
    let n = l(a);
    try {
      let e = V(t.formData);
      r && n.search && he(n.search) && e.append('index', ''),
        (n.search = '?' + e);
    } catch (e) {
      return {
        path: a,
  ...
  function I(e, t) {
    ...
    return {
      state: 'loading',
      location: i(e.location, t.location),
      formMethod: r || void 0,
      formAction: a || void 0,
      formEncType: n || void 0,
      formData: o || void 0,
    };
  }
  function B(e, t) {
  ...
  function z(e, t, r, a, n, o, i, s, l, c) {
    let d = l ? Object.values(l)[0] : s ? Object.values(s)[0] : null,
      u = B(t, l ? Object.keys(l)[0] : void 0).filter(
        (t, i) =>
          null != t.route.loader &&
          ((function (e, t, r) {
            ...
            o.some((e) => e === t.route.id) ||
            J(e.location, e.matches[i], r, a, t, n, d)),
      ),
      h = [];
    return (
      c &&
        c.forEach((e, t) => {
          let [a, o, s] = e;
          if (i.includes(t)) h.push([t, a, o, s]);
          else if (n) {
            J(a, o, r, a, o, n, d) && h.push([t, a, o, s]);
          }
        }),
      [u, h]
    );
  ...
  function J(e, r, a, n, o, i, s) {
    let l = c(e),
      d = r.params,
      u = c(n),
      h = o.params,
      f =
        K(r, o) || l.toString() === u.toString() || l.search !== u.search || i;
    if (o.route.shouldRevalidate) {
      let e = o.route.shouldRevalidate(
        t({ currentUrl: l, currentParams: d, nextUrl: u, nextParams: h }, a, {
          actionResult: s,
  ...
  async function Y(e, t, r, a, n, o, i) {
    let l, d, h;
    void 0 === o && (o = !1), void 0 === i && (i = !1);
    let f = new Promise((e, t) => (h = t)),
      p = () => h();
    ...
    try {
      ...
      E(
        ...
        (d = await Promise.race([a({ request: t, params: r.params }), f]));
    } catch (e) {
      (l = u.error), (d = e);
    } finally {
    ...
    if (d instanceof Response) {
      ...
      if (h >= 300 && h <= 399) {
        ...
        let i = M(
          e,
          x(a.slice(0, a.indexOf(r) + 1)).map((e) => e.pathnameBase),
          c(t.url).pathname,
        );
        if (
          (E(
            s(i),
            'Unable to resolve redirect location: ' + d.headers.get('Location'),
          ),
          n)
        ) {
          let e = i.pathname;
          i.pathname = '/' === e ? n : S([n, e]);
        }
        if (((e = s(i)), o)) throw (d.headers.set('Location', e), d);
        return {
          type: u.redirect,
          status: h,
          location: e,
      ...
      if (i) throw { type: l || u.data, response: d };
      let f = d.headers.get('Content-Type');
      return (
        (e =
          f && f.startsWith('application/json')
            ? await d.json()
            : await d.text()),
        l === u.error
          ? { type: l, error: new U(h, d.statusText, e), headers: d.headers }
          : { type: u.data, data: e, statusCode: d.status, headers: d.headers }
      );
    }
    return l === u.error
      ? { type: l, error: d }
      : d instanceof O
      ? { type: u.deferred, deferredData: d }
      : { type: u.data, data: d };
  }
  function G(e, t, r) {
    let a = c(oe(e)).toString(),
      n = { signal: t };
    if (r) {
      let { formMethod: e, formEncType: t, formData: a } = r;
      (n.method = e.toUpperCase()),
        (n.body = 'application/x-www-form-urlencoded' === t ? V(a) : a);
    }
  ...
  function X(e, t, r, a, n) {
    ...
    return (
      r.forEach((r, d) => {
        let u = t[d].route.id;
        if (
          (E(!le(r), 'Cannot handle redirect results in processLoaderData'),
          se(r))
        ) {
          let t = ee(e, u),
            n = r.error;
          a && ((n = Object.values(a)[0]), (a = void 0)),
            (s = Object.assign(s || {}, { [t.route.id]: n })),
            l || ((l = !0), (o = _(r.error) ? r.error.status : 500)),
            r.headers && (c[u] = r.headers);
        } else
          ie(r)
            ? (n && n.set(u, r.deferredData), (i[u] = r.deferredData.data))
            : ((i[u] = r.data),
              null == r.statusCode ||
                200 === r.statusCode ||
                l ||
  ...
  function Q(e, r, a, n, o, i, s, l) {
    let { loaderData: c, errors: d } = X(r, a, n, o, l);
    for (let r = 0; r < i.length; r++) {
      ...
      let o = s[r];
      if (se(o)) {
        let r = ee(e.matches, n.route.id);
        (d && d[r.route.id]) || (d = t({}, d, { [r.route.id]: o.error })),
          e.fetchers.delete(a);
      } else {
        if (le(o)) throw new Error('Unhandled fetcher revalidation redirect');
        if (ie(o)) throw new Error('Unhandled fetcher deferred data');
        {
          let t = {
            state: 'idle',
            data: o.data,
  ...
  function te(e, t, r) {
    let a = e.find((e) => e.index || !e.path || '/' === e.path) || {
      id: '__shim-' + t + '-route__',
    };
    return {
      matches: [{ params: {}, pathname: '', pathnameBase: '', route: a }],
      route: a,
      error: new U(t, r, null),
    };
  }
  function re(e) {
    return te(e, 404, 'Not Found');
  }
  function ae(e) {
    let t = 'string' == typeof e ? e : s(e);
    return (
      console.warn(
      ...
      { type: u.error, error: new U(405, 'Method Not Allowed', '') }
    );
  }
  function ne(e) {
  ...
  function oe(e) {
    return s(t({}, 'string' == typeof e ? l(e) : e, { hash: '' }));
  }
  function ie(e) {
  ...
  function ce(e) {
    if (!(e instanceof Response)) return !1;
    let t = e.status,
      r = e.headers.get('Location');
    return t >= 300 && t <= 399 && null != r;
  }
  async function de(e, t, r, a, n, o) {
    for (let i = 0; i < r.length; i++) {
      let s = r[i],
        l = t[i],
        c = e.find((e) => e.route.id === l.route.id),
        d = null != c && !K(c, l) && void 0 !== (o && o[l.route.id]);
      ie(s) &&
        (n || d) &&
        (await ue(s, a, n).then((e) => {
          e && (r[i] = e || r[i]);
        }));
    }
  }
  async function ue(e, t, r) {
    if ((void 0 === r && (r = !1), !(await e.deferredData.resolveData(t)))) {
      if (r)
        try {
          return { type: u.data, data: e.deferredData.unwrappedData };
        } catch (e) {
          return { type: u.error, error: e };
        }
      return { type: u.data, data: e.deferredData.data };
    }
  }
  function he(e) {
  ...
  function pe(e, t) {
    let r = 'string' == typeof t ? l(t).search : t.search;
    if (e[e.length - 1].route.index && he(r || '')) return e[e.length - 1];
    let a = x(e);
    return a[a.length - 1];
  }
  (e.AbortedDeferredError = L),
    (e.ErrorResponse = U),
    (e.IDLE_FETCHER = N),
    (e.IDLE_NAVIGATION = k),
    (e.UNSAFE_convertRoutesToDataRoutes = h),
    (e.UNSAFE_getPathContributingMatches = x),
    (e.createBrowserHistory = function (e) {
      return (
        void 0 === e && (e = {}),
        d(
          function (e, t) {
      ...
      return (
        ...
        d(
          ...
          function (e, t) {
            ...
            return a + '#' + ('string' == typeof t ? t : s(t));
          },
          function (e, t) {
            n(
              '/' === e.pathname.charAt(0),
    ...
    (e.createMemoryHistory = function (t) {
      void 0 === t && (t = {});
      let r,
        { initialEntries: a = ['/'], initialIndex: o, v5Compat: l = !1 } = t;
      r = a.map((e, t) =>
        p(
          e,
      ...
      return {
        ...
        createHref: (e) => ('string' == typeof e ? e : s(e)),
        encodeLocation: (e) => e,
        push(t, a) {
          d = e.Action.Push;
          let n = p(t, a);
          (c += 1),
            r.splice(c, r.length, n),
            l && u && u({ action: d, location: n });
        },
        replace(t, a) {
          d = e.Action.Replace;
          let n = p(t, a);
          (r[c] = n), l && u && u({ action: d, location: n });
        },
        go(t) {
          (d = e.Action.Pop),
            (c = h(c + t)),
            u && u({ action: d, location: f() });
        },
        listen: (e) => (
          (u = e),
          () => {
    ...
    (e.createRouter = function (r) {
      ...
      let a = h(r.routes),
        ...
        c = null,
        d = !1,
        u = f(a, r.history.location, r.basename),
        p = null;
      if (null == u) {
        let { matches: e, route: t, error: r } = re(a);
        (u = e), (p = { [t.id]: r });
      }
      let m,
        g,
        v = !u.some((e) => e.route.loader) || null != r.hydrationData,
        y = {
          ...
          errors: (r.hydrationData && r.hydrationData.errors) || p,
          fetchers: new Map(),
        },
        w = e.Action.Pop,
        b = !1,
        ...
        O(
          t(
            ...
            null != y.actionData &&
              ...
              (null == (o = y.navigation.formAction)
                ? void 0
                : o.split('?')[0]) === a.pathname
              ? {}
              : { actionData: null },
            n,
            n.loaderData
              ? { loaderData: Z(y.loaderData, n.loaderData, n.matches || []) }
              : {},
            {
              historyAction: w,
              location: a,
              ...
              restoreScrollPosition:
                !y.navigation.formData && he(a, n.matches || y.matches),
          ...
          D ||
            w === e.Action.Pop ||
            (w === e.Action.Push
              ? r.history.push(a, a.state)
              : w === e.Action.Replace && r.history.replace(a, a.state)),
          (w = e.Action.Pop),
          (b = !1),
          (D = !1),
          (A = !1),
      ...
      async function _(n, o, d) {
        g && g.abort(),
          (g = null),
          (w = n),
          (D = !0 === (d && d.startUninterruptedRevalidation)),
          (function (e, t) {
            if (s && l && c) {
              let r = t.map((e) => fe(e, y.loaderData)),
                a = l(e, r) || e.key;
              s[a] = c();
            }
          })(y.location, y.matches),
          (b = !0 === (d && d.preventScrollReset));
        ...
        if (!h) {
          ...
          return (
            ce(),
            void H(o, { matches: e, loaderData: {}, errors: { [t.id]: r } })
          );
        }
        if (
          ((p = y.location),
          ...
          return void H(o, { matches: h });
        var p, v;
        g = new AbortController();
        let C,
          U,
          _ = G(o, g.signal, d && d.submission);
        if (d && d.pendingError) U = { [ee(h).route.id]: d.pendingError };
        else if (d && d.submission) {
          let r = await (async function (r, a, n, o, s) {
            let l;
            K(), O({ navigation: t({ state: 'submitting', location: a }, n) });
            let c = pe(o, a);
            if (c.route.action) {
              if (
                ((l = await Y('action', r, c, o, m.basename)), r.signal.aborted)
              )
                return { shortCircuited: !0 };
            } else l = ae(a);
            if (le(l)) {
              let e = t(
                { state: 'loading', location: i(y.location, l.location) },
                n,
              );
              return await q(l, e, s && s.replace), { shortCircuited: !0 };
            }
            if (se(l)) {
              let t = ee(o, c.route.id);
              return (
                !0 !== (s && s.replace) && (w = e.Action.Push),
                { pendingActionError: { [t.route.id]: l.error } }
              );
            }
            if (ie(l)) throw new Error('defer() is not supported in actions');
            return { pendingActionData: { [c.route.id]: l.data } };
          })(_, o, d.submission, h, { replace: d.replace });
          if (r.shortCircuited) return;
          (C = r.pendingActionData),
            (U = r.pendingActionError),
            (u = t({ state: 'loading', location: o }, d.submission));
        }
        let {
          shortCircuited: k,
          loaderData: N,
          errors: W,
        } = await (async function (e, r, a, n, o, i, s, l) {
          let c = n;
          if (!c) {
            c = {
              state: 'loading',
          ...
          let [d, u] = z(y, a, o, r, A, R, P, s, l, j);
          if (
            (ce(
              (e) =>
                !(a && a.some((t) => t.route.id === e)) ||
                (d && d.some((t) => t.route.id === e)),
            ),
            0 === d.length && 0 === u.length)
          )
            return (
              H(r, {
                matches: a,
                loaderData: Z(y.loaderData, {}, a),
                errors: l || null,
                actionData: s || null,
              }),
              { shortCircuited: !0 }
          ...
          D ||
            ...
            O(
              t(
                { navigation: c, actionData: s || y.actionData || null },
                u.length > 0 ? { fetchers: new Map(y.fetchers) } : {},
              ),
            ));
          (S = ++M),
            u.forEach((e) => {
          ...
          if (m) {
            let e = I(y, m);
            return await q(m, e, i), { shortCircuited: !0 };
          }
          let { loaderData: v, errors: w } = Q(y, a, d, f, l, u, p, L);
          L.forEach((e, t) => {
            e.subscribe((r) => {
              (r || e.done) && L.delete(t);
            });
            ...
            (function () {
              let e = [];
              for (let t of T) {
                let r = y.fetchers.get(t);
                E(r, 'Expected fetcher: ' + t),
                  'loading' === r.state && (T.delete(t), e.push(t));
              }
              te(e);
            })();
          let b = oe(S);
          return t(
            { loaderData: v, errors: w },
            b || u.length > 0 ? { fetchers: new Map(y.fetchers) } : {},
          );
        })(_, o, h, u, d && d.submission, d && d.replace, C, U);
        k || ((g = null), H(o, { matches: h, loaderData: N, errors: W }));
      }
      function $(e) {
        return y.fetchers.get(e) || N;
      }
      async function q(t, r, a) {
        t.revalidate && (A = !0),
          E(r.location, 'Expected a location on the redirect navigation'),
          (g = null);
        let n = !0 === a ? e.Action.Replace : e.Action.Push;
        await _(n, r.location, { overrideNavigation: r });
      }
      async function B(e, t, r, a, n) {
        let o = await Promise.all([
            ...r.map((e) => Y('loader', n, e, t, m.basename)),
            ...a.map((e) => {
              let [, t, r, a] = e;
              return Y('loader', G(t, n.signal), r, a, m.basename);
            }),
          ]),
        ...
        return (
          await Promise.all([
            de(e, r, i, n.signal, !1, y.loaderData),
            de(
              e,
              a.map((e) => {
                let [, , t] = e;
      ...
      function K() {
        (A = !0),
          R.push(...ce()),
          j.forEach((e, t) => {
            x.has(t) && (P.push(t), X(t));
          });
      }
      function J(e, t, r) {
        let a = ee(y.matches, t);
        V(e), O({ errors: { [a.route.id]: r }, fetchers: new Map(y.fetchers) });
      }
      function V(e) {
        x.has(e) && X(e),
          j.delete(e),
      ...
      function X(e) {
        let t = x.get(e);
        E(t, 'Expected fetch controller: ' + e), t.abort(), x.delete(e);
      }
      function te(e) {
        for (let t of e) {
          let e = {
      ...
      function oe(e) {
        ...
        for (let [r, a] of C)
          if (a < e) {
            ...
            E(e, 'Expected fetcher: ' + r),
              'loading' === e.state && (X(r), C.delete(r), t.push(r));
          }
      ...
      function ce(e) {
        ...
        return (
          L.forEach((r, a) => {
            (e && !e(a)) || (r.cancel(), t.push(a), L.delete(a));
          }),
          t
        );
      }
      ...
      return (
        (m = {
          ...
          initialize: function () {
            return (
              (n = r.history.listen((e) => {
                let { action: t, location: r } = e;
                return _(t, r);
              })),
              y.initialized || _(e.Action.Pop, y.location),
              m
            );
          },
          ...
          enableScrollRestoration: function (e, t, r) {
            if (
              ...
              null != e && O({ restoreScrollPosition: e });
            }
            return () => {
              (s = null), (c = null), (l = null);
            };
          },
          navigate: async function (t, a) {
            if ('number' == typeof t) return void r.history.go(t);
            let { path: n, submission: o, error: s } = F(t, a),
              l = i(y.location, n, a && a.state);
            l = r.history.encodeLocation(l);
            let c =
                !0 === (a && a.replace) || null != o
                  ? e.Action.Replace
                  : e.Action.Push,
              d =
          ...
          fetch: function (e, n, o, s) {
            if (W)
              throw new Error(
                "router.fetch() was called during the server render, but it shouldn't be. You are likely calling a useFetcher() method in the body of your component. Try moving it to a useEffect or a callback.",
              );
            x.has(e) && X(e);
            let l = f(a, o, r.basename);
            if (!l) return void J(e, n, new U(404, 'Not Found', null));
            let { path: c, submission: d } = F(o, s, !0),
              u = pe(l, c);
            d
              ? (async function (e, n, o, s, l, c) {
                  if ((K(), j.delete(e), !s.route.action)) {
                    let { error: t } = ae(o);
                    return void J(e, n, t);
                  }
                  let d = y.fetchers.get(e),
                    u = t({ state: 'submitting' }, c, { data: d && d.data });
                  y.fetchers.set(e, u), O({ fetchers: new Map(y.fetchers) });
                  let h = new AbortController(),
                    p = G(o, h.signal, c);
                  x.set(e, h);
                  let v = await Y('action', p, s, l, m.basename);
                  if (p.signal.aborted)
                    return void (x.get(e) === h && x.delete(e));
                  if (le(v)) {
                    x.delete(e), T.add(e);
                    let r = t({ state: 'loading' }, c, { data: void 0 });
                    y.fetchers.set(e, r), O({ fetchers: new Map(y.fetchers) });
                    let a = t(
                      { state: 'loading', location: i(y.location, v.location) },
                      c,
                    );
                    return void (await q(v, a));
                  }
                  if (se(v)) return void J(e, n, v.error);
                  ie(v) && E(!1, 'defer() is not supported in actions');
                  let b = y.navigation.location || y.location,
                    D = G(b, h.signal),
                    U =
                      'idle' !== y.navigation.state
                        ? f(a, y.navigation.location, r.basename)
                        : y.matches;
                  E(U, "Didn't find any matches after fetcher action");
                  let _ = ++M;
                  C.set(e, _);
                  let k = t({ state: 'loading', data: v.data }, c);
                  y.fetchers.set(e, k);
                  let [N, W] = z(
                    y,
                    U,
                  ...
                  W.filter((t) => {
                    ...
                    y.fetchers.set(t, a), x.set(t, h);
                  }),
                    O({ fetchers: new Map(y.fetchers) });
                  let {
                    results: $,
                    loaderResults: F,
                    fetcherResults: V,
                  } = await B(y.matches, U, N, W, D);
                  ...
                  if (X) {
                    let e = I(y, X);
                    return void (await q(X, e));
                  }
                  let { loaderData: ee, errors: te } = Q(
                      y,
                      y.matches,
                      N,
                      F,
                  ...
                  y.fetchers.set(e, re);
                  let ce = oe(_);
                  'loading' === y.navigation.state && _ > S
                    ? (E(w, 'Expected pending action'),
                      g && g.abort(),
                    ...
                    : (O(
                        t(
                          { errors: te, loaderData: Z(y.loaderData, ee, U) },
                          ce ? { fetchers: new Map(y.fetchers) } : {},
                        ),
                      ),
                      (A = !1));
                })(e, n, c, u, l, d)
              : (j.set(e, [c, u, l]),
                (async function (e, t, r, a, n) {
                  ...
                  y.fetchers.set(e, i), O({ fetchers: new Map(y.fetchers) });
                  let s = new AbortController(),
                    l = G(r, s.signal);
                  x.set(e, s);
                  let c = await Y('loader', l, a, n, m.basename);
                  ie(c) && (c = (await ue(c, l.signal, !0)) || c);
                  x.get(e) === s && x.delete(e);
                  if (l.signal.aborted) return;
                  if (le(c)) {
                    let e = I(y, c);
                    return void (await q(c, e));
                  }
                  if (se(c)) {
                    let r = ee(y.matches, t);
                    return (
                      y.fetchers.delete(e),
                      void O({
                        fetchers: new Map(y.fetchers),
                        errors: { [r.route.id]: c.error },
                      })
                    );
                  }
                  E(!ie(c), 'Unhandled fetcher deferred data');
                  let d = {
                    state: 'idle',
                    data: c.data,
                    formMethod: void 0,
                  ...
                  y.fetchers.set(e, d), O({ fetchers: new Map(y.fetchers) });
                })(e, n, c, u, l));
          },
          revalidate: function () {
            K(),
              ...
              'submitting' !== y.navigation.state &&
                ('idle' !== y.navigation.state
                  ? _(w || y.historyAction, y.navigation.location, {
                      overrideNavigation: y.navigation,
                    })
                  : _(y.historyAction, y.location, {
    ...
    (e.generatePath = function (e, t) {
      return (
        ...
        e
          .replace(
            /:(\w+)/g,
            (e, r) => (E(null != t[r], 'Missing ":' + r + '" param'), t[r]),
          )
          .replace(/(\/?)\*/, (e, r, a, n) =>
            null == t['*'] ? ('/*' === n ? '/' : '') : '' + r + t['*'],
          )
    ...
    (e.getStaticContextFromError = function (e, r, a) {
      return t({}, r, {
        statusCode: 500,
        errors: { [r._deepestRenderedBoundaryId || e[0].id]: a },
      });
    }),
    ...
    (e.invariant = E),
    (e.isRouteErrorResponse = _),
    (e.joinPaths = S),
    (e.json = function (e, r) {
      void 0 === r && (r = {});
      let a = 'number' == typeof r ? { status: r } : r,
        n = new Headers(a.headers);
      return (
        n.has('Content-Type') ||
          n.set('Content-Type', 'application/json; charset=utf-8'),
        new Response(JSON.stringify(e), t({}, a, { headers: n }))
      );
    }),
    (e.matchPath = w),
    (e.matchRoutes = f),
    (e.normalizePathname = C),
    (e.parsePath = l),
    (e.redirect = function (e, r) {
      void 0 === r && (r = 302);
      let a = r;
      'number' == typeof a
        ? (a = { status: a })
      ...
      return n.set('Location', e), new Response(null, t({}, a, { headers: n }));
    }),
    (e.resolvePath = R),
    (e.resolveTo = M),
    (e.stripBasename = D),
    (e.unstable_createStaticHandler = function (e) {
      E(
        e.length > 0,
        'You must provide a non-empty routes array to unstable_createStaticHandler',
      );
      let r = h(e);
      async function a(e, r, a, i) {
        E(
          e.signal,
        ...
        try {
          if ($.has(e.method)) {
            let s = await (async function (e, r, a, i) {
              let s;
              if (a.route.action) {
                if (
                  ((s = await Y('action', e, a, r, void 0, !0, i)),
                  e.signal.aborted)
                ) {
                  throw new Error(
              ...
              if (ie(s)) throw new Error('defer() is not supported in actions');
              if (i) {
                if (se(s)) {
                  return {
                    matches: [a],
                    loaderData: {},
                    actionData: null,
                    errors: { [ee(r, a.route.id).route.id]: s.error },
                    statusCode: 500,
                    loaderHeaders: {},
                    actionHeaders: {},
                  };
              ...
              if (se(s)) {
                let o = ee(r, a.route.id);
                return t({}, await n(e, r, void 0, { [o.route.id]: s.error }), {
                  statusCode: _(s.error) ? s.error.status : 500,
                  actionData: null,
                  actionHeaders: t(
                    {},
                    s.headers ? { [a.route.id]: s.headers } : {},
                  ),
                });
              }
              return t(
          ...
          return s instanceof Response
            ? s
            : t({}, s, { actionData: null, actionHeaders: {} });
        } catch (e) {
          if (
            (s = e) &&
            s.response instanceof Response &&
            (s.type === u.data || u.error)
          ) {
            if (e.type === u.error && !ce(e.response)) throw e.response;
            return e.response;
          }
          if (ce(e)) return e;
          throw e;
      ...
      async function n(e, r, a, n) {
        let o = null != a,
          i = (a ? [a] : B(r, Object.keys(n || {})[0])).filter(
            (e) => e.route.loader,
          );
        if (0 === i.length)
          return {
        ...
        let s = await Promise.all([
          ...i.map((t) => Y('loader', e, t, r, void 0, !0, o)),
        ]);
        if (e.signal.aborted) {
          throw new Error((o ? 'queryRoute' : 'query') + '() call aborted');
        }
        return (
          s.forEach((e) => {
            ie(e) && e.deferredData.cancel();
          }),
          t({}, X(r, i, s, n), { matches: r })
        );
      }
      function o(e, r) {
        return new Response(
          e,
          t({}, r, {
            headers: t({}, r.headers, { 'X-Remix-Router-Error': 'yes' }),
          }),
        );
      }
      return {
        ...
        query: async function (e) {
          let n = i('', s(new URL(e.url)), null, 'default'),
            o = f(r, n);
          if (!q.has(e.method)) {
            let {
              matches: e,
              ...
              return te(e, 405, 'Method Not Allowed');
            })(r);
            return {
              location: n,
              matches: e,
          ...
          if (!o) {
            let { matches: e, route: t, error: a } = re(r);
            return {
              location: n,
              matches: e,
              loaderData: {},
          ...
          let l = await a(e, n, o);
          return l instanceof Response ? l : t({ location: n }, l);
        },
        queryRoute: async function (e, t) {
          let n = i('', s(new URL(e.url)), null, 'default'),
            l = f(r, n);
          if (!q.has(e.method))
            throw o(null, { status: 405, statusText: 'Method Not Allowed' });
          if (!l) throw o(null, { status: 404, statusText: 'Not Found' });
          let c = t ? l.find((e) => e.route.id === t) : pe(l, n);
          if (!c) throw o(null, { status: 404, statusText: 'Not Found' });
          let d = await a(e, n, l, c);
          if (d instanceof Response) return d;
          let u = d.errors ? Object.values(d.errors)[0] : void 0;
          if (void 0 !== u) throw u;
          let h = [d.actionData, d.loaderData].find((e) => e);
          return Object.values(h || {})[0];
        },
      };
    }),
    (e.warning = A),
...
//static/lib/react-router/6.4.3/dist/umd/react-router.production.min.js
/**
 * React Router v6.4.3
 *
 * Copyright (c) Remix Software Inc.
...
!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ? t(exports, require('@remix-run/router'), require('react'))
    : 'function' == typeof define && define.amd
    ? define(['exports', '@remix-run/router', 'react'], t)
    : t(
        ((e =
          'undefined' != typeof globalThis
            ? globalThis
  ...
  const i =
    ...
    { useState: u, useEffect: l, useLayoutEffect: s, useDebugValue: c } = a;
  function d(e) {
  ...
  const p = !!(
      ...
      : function (e, t, r) {
          const n = t(),
            [{ inst: a }, o] = u({ inst: { value: n, getSnapshot: t } });
          return (
            s(() => {
              (a.value = n), (a.getSnapshot = t), d(a) && o({ inst: a });
            }, [e, n, t]),
            l(() => {
              d(a) && o({ inst: a });
              return e(() => {
    ...
    h = 'useSyncExternalStore' in a ? ((e) => e.useSyncExternalStore)(a) : p,
    ...
    b = a.createContext({ outlet: null, matches: [] }),
    x = a.createContext(null);
  function P() {
    return null != a.useContext(E);
  }
  function R() {
    return P() || t.invariant(!1), a.useContext(E).location;
  }
  function C() {
    P() || t.invariant(!1);
    let { basename: e, navigator: r } = a.useContext(y),
      { matches: n } = a.useContext(b),
      { pathname: o } = R(),
      i = JSON.stringify(
        t.UNSAFE_getPathContributingMatches(n).map((e) => e.pathnameBase),
      ),
      u = a.useRef(!1);
    return (
      a.useEffect(() => {
      ...
      a.useCallback(
        function (n, a) {
          ...
          let l = t.resolveTo(n, JSON.parse(i), o, 'path' === a.relative);
          '/' !== e &&
            (l.pathname =
              '/' === l.pathname ? e : t.joinPaths([e, l.pathname])),
  ...
  function j(e) {
    ...
    return t ? a.createElement(O.Provider, { value: e }, t) : t;
  }
  function S(e, r) {
    let { relative: n } = void 0 === r ? {} : r,
      { matches: o } = a.useContext(b),
      { pathname: i } = R(),
      u = JSON.stringify(
        t.UNSAFE_getPathContributingMatches(o).map((e) => e.pathnameBase),
      );
    return a.useMemo(
      () => t.resolveTo(e, JSON.parse(u), i, 'path' === n),
      [e, u, i, n],
    );
  }
  function D(e, r) {
    ...
    let h = c.pathname || '/',
      ...
      f = t.matchRoutes(e, { pathname: m }),
      g = N(
        f &&
          f.map((e) =>
            Object.assign({}, e, {
              params: Object.assign({}, l, e.params),
              pathname: t.joinPaths([s, e.pathname]),
              pathnameBase:
                '/' === e.pathnameBase ? s : t.joinPaths([s, e.pathnameBase]),
            }),
          ),
        i,
        n || void 0,
  ...
  function _() {
    ...
    return a.createElement(
      ...
      a.createElement('p', null, '馃捒 Hey developer 馃憢'),
      a.createElement(
        'p',
        null,
        'You can provide a way better UX than this when your app throws errors by providing your own聽',
        a.createElement('code', { style: u }, 'errorElement'),
        ' props on聽',
        a.createElement('code', { style: u }, '<Route>'),
      ),
    );
  }
  ...
  function A(e) {
    ...
    return (
      ...
      a.createElement(b.Provider, { value: t }, n)
    );
  }
  function N(e, r, n) {
    ...
    if (null != i) {
      ...
      e >= 0 || t.invariant(!1), (o = o.slice(0, Math.min(o.length, e + 1)));
    }
    return o.reduceRight((e, t, u) => {
      let l = t.route.id ? (null == i ? void 0 : i[t.route.id]) : null,
        s = n ? t.route.errorElement || a.createElement(_, null) : null,
        c = () =>
          a.createElement(
            A,
            {
              match: t,
              routeContext: { outlet: e, matches: r.concat(o.slice(0, u + 1)) },
            },
            l ? s : void 0 !== t.route.element ? t.route.element : e,
          );
      return n && (t.route.errorElement || 0 === u)
        ? a.createElement(U, {
            location: n.location,
            component: s,
            error: l,
  ...
  var M, w, F;
  function T(e) {
    let r = a.useContext(v);
    return r || t.invariant(!1), r;
  }
  function k() {
    var e;
    let r = a.useContext(x),
      n = T(w.UseRouteError),
      o = a.useContext(b),
  ...
  function H(e) {
    ...
    let s = r.replace(/^\/*/, '/'),
      c = a.useMemo(
        () => ({ basename: s, navigator: u, static: l }),
        [s, u, l],
      );
    'string' == typeof o && (o = t.parsePath(o));
    let {
        pathname: d = '/',
        search: p = '',
        hash: h = '',
      ...
      v = a.useMemo(() => {
        let e = t.stripBasename(d, s);
        return null == e
          ? null
          : { pathname: e, search: p, hash: h, state: m, key: f };
      }, [s, d, p, h, m, f]);
    return null == v
      ? null
      : a.createElement(
  ...
  function I(e) {
    let { children: t, location: r } = e,
      n = a.useContext(f);
    return D(n && !t ? n.router.routes : q(t), r);
  }
  !(function (e) {
  ...
  class z extends a.Component {
    ...
    render() {
      let { children: e, errorElement: r, resolve: n } = this.props,
        o = null,
        i = F.pending;
      ...
      if (i === F.error && o._error instanceof t.AbortedDeferredError) throw J;
      if (i === F.error && !r) throw o._error;
      if (i === F.error)
        return a.createElement(g.Provider, { value: o, children: r });
      if (i === F.success)
        return a.createElement(g.Provider, { value: o, children: e });
      throw o;
    }
  }
  function V(e) {
    ...
    return (
      a.Children.forEach(e, (e, o) => {
        ...
        if (e.type === a.Fragment)
          return void n.push.apply(n, q(e.props.children, r));
        e.type !== B && t.invariant(!1),
          e.props.index && e.props.children && t.invariant(!1);
        let i = [...r, o],
          u = {
        ...
        e.props.children && (u.children = q(e.props.children, i)), n.push(u);
      }),
      n
    );
  }
  function W(e) {
    return e.map((e) => {
      ...
      return (
        ...
        t.children && (t.children = W(t.children)),
        t
      );
    });
  }
  Object.defineProperty(e, 'AbortedDeferredError', {
    ...
    (e.MemoryRouter = function (e) {
      let { basename: r, children: n, initialEntries: o, initialIndex: i } = e,
        u = a.useRef();
      null == u.current &&
      ...
      let l = u.current,
        [s, c] = a.useState({ action: l.action, location: l.location });
      return (
        a.useLayoutEffect(() => l.listen(c), [l]),
        a.createElement(H, {
          basename: r,
          children: n,
          location: s.location,
    ...
    (e.Navigate = function (e) {
      let { to: r, replace: n, state: o, relative: i } = e;
      P() || t.invariant(!1);
      let u = a.useContext(v),
        l = C();
      return (
        a.useEffect(() => {
          (u && 'idle' !== u.navigation.state) ||
            l(r, { replace: n, state: o, relative: i });
        }),
        null
      );
    }),
      ...
      return a.createElement(
        ...
        a.createElement(
          ...
          a.createElement(
            ...
            r.state.initialized ? a.createElement(I, null) : t,
          ),
        ),
      );
    }),
    (e.Routes = I),
    (e.UNSAFE_DataRouterContext = f),
    (e.UNSAFE_DataRouterStateContext = v),
    (e.UNSAFE_DataStaticRouterContext = m),
    (e.UNSAFE_LocationContext = E),
    (e.UNSAFE_NavigationContext = y),
    (e.UNSAFE_RouteContext = b),
    (e.UNSAFE_enhanceManualRouteObjects = W),
    (e.createMemoryRouter = function (e, r) {
      return t
        .createRouter({
    ...
    (e.useActionData = function () {
      let e = T(w.UseActionData);
      return (
        a.useContext(b) || t.invariant(!1),
    ...
    (e.useAsyncValue = L),
    (e.useHref = function (e, r) {
      let { relative: n } = void 0 === r ? {} : r;
      P() || t.invariant(!1);
      let { basename: o, navigator: i } = a.useContext(y),
        { hash: u, pathname: l, search: s } = S(e, { relative: n }),
        c = l;
      return (
        '/' !== o && (c = '/' === l ? o : t.joinPaths([o, l])),
        i.createHref({ pathname: c, search: s, hash: u })
      );
    }),
    (e.useInRouterContext = P),
    (e.useLoaderData = function () {
      let e = T(w.UseLoaderData),
        r = a.useContext(b);
      r || t.invariant(!1);
      let n = r.matches[r.matches.length - 1];
      return n.route.id || t.invariant(!1), e.loaderData[n.route.id];
    }),
    (e.useLocation = R),
    (e.useMatch = function (e) {
      P() || t.invariant(!1);
      let { pathname: r } = R();
      return a.useMemo(() => t.matchPath(e, r), [r, e]);
    }),
    (e.useMatches = function () {
      let { matches: e, loaderData: t } = T(w.UseMatches);
      return a.useMemo(
        () =>
          e.map((e) => {
            let { pathname: r, params: n } = e;
            return {
              id: e.route.id,
              pathname: r,
              params: n,
    ...
    (e.useNavigation = function () {
      return T(w.UseNavigation).navigation;
    }),
    ...
    (e.useRevalidator = function () {
      let e = (function (e) {
        ...
        r = T(w.UseRevalidator);
      return { revalidate: e.router.revalidate, state: r.revalidation };
    }),
    (e.useRouteError = k),
    (e.useRouteLoaderData = function (e) {
      return T(w.UseRouteLoaderData).loaderData[e];
    }),
    (e.useRoutes = D),
    Object.defineProperty(e, '__esModule', { value: !0 });
});

//static/lib/react-router-dom/6.4.3/dist/umd/react-router-dom.production.min.js
/**
...
!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
    ? define(['exports', 'react', 'react-router', '@remix-run/router'], t)
    : t(
        ((e =
          'undefined' != typeof globalThis
            ? globalThis
  ...
  function d(e, t, r) {
    let n, o, a, u;
    if (s((i = e)) && 'form' === i.tagName.toLowerCase()) {
      let i = r.submissionTrigger;
      (n = r.method || e.getAttribute('method') || c),
        (o = r.action || e.getAttribute('action') || t),
        (a = r.encType || e.getAttribute('enctype') || l),
        (u = new FormData(e)),
        i && i.name && u.append(i.name, i.value);
    } else if (
      (function (e) {
        return s(e) && 'button' === e.tagName.toLowerCase();
      })(e) ||
      ((function (e) {
        return s(e) && 'input' === e.tagName.toLowerCase();
      })(e) &&
      ...
      (n =
        ...
        (a =
          ...
          l),
        (u = new FormData(i)),
        e.name && u.append(e.name, e.value);
    } else {
      if (s(e))
        throw new Error(
      ...
      if (
        ...
        u = e;
      else if (((u = new FormData()), e instanceof URLSearchParams))
        for (let [t, r] of e) u.append(t, r);
      else if (null != e) for (let t of Object.keys(e)) u.append(t, e[t]);
    }
    var i;
    let { protocol: f, host: d } = window.location;
    return {
      url: new URL(o, f + '//' + d),
      method: n,
      encType: a,
  ...
  const h = a.forwardRef(function (e, t) {
    ...
    y = a.forwardRef(function (e, t) {
      let {
        ...
        m = i(e, b),
        p = r.useResolvedPath(f, { relative: m.relative }),
        y = r.useLocation(),
        g = a.useContext(r.UNSAFE_DataRouterStateContext),
        v = p.pathname,
        R = y.pathname,
        P =
      ...
      o ||
        ...
        (v = v.toLowerCase()));
      let w,
        O = R === v || (!l && R.startsWith(v) && '/' === R.charAt(v.length)),
        j =
          null != P &&
          (P === v || (!l && P.startsWith(v) && '/' === P.charAt(v.length))),
        S = O ? n : void 0;
      w =
        'function' == typeof c
          ? c({ isActive: O, isPending: j })
          : [c, O ? 'active' : null, j ? 'pending' : null]
              .filter(Boolean)
              .join(' ');
      let E = 'function' == typeof s ? s({ isActive: O, isPending: j }) : s;
      return a.createElement(
        h,
        u({}, m, { 'aria-current': S, className: w, ref: t, style: E, to: f }),
        'function' == typeof d ? d({ isActive: O, isPending: j }) : d,
      );
    }),
    g = a.forwardRef((e, t) => a.createElement(v, u({}, e, { ref: t }))),
    v = a.forwardRef((e, t) => {
      let {
          reloadDocument: r,
          replace: n,
  ...
  function j(e, t) {
    let {
      ...
      l = r.useNavigate(),
      s = r.useLocation(),
      f = r.useResolvedPath(e, { relative: c });
    return a.useCallback(
      (t) => {
        if (
          ...
          t.preventDefault();
          let n = void 0 !== o ? o : r.createPath(s) === r.createPath(f);
          l(e, { replace: n, state: u, preventScrollReset: i, relative: c });
        }
      },
      [s, l, f, o, u, n, e, i, c],
    );
  ...
  function S(e, t) {
    let { router: r } = w(R.UseSubmitImpl),
      o = E();
    return a.useCallback(
      function (a, u) {
        if ((void 0 === u && (u = {}), 'undefined' == typeof document))
          throw new Error(
            'You are calling submit during the server render. Try calling submit within a `useEffect` or callback instead.',
          );
        let { method: i, encType: c, formData: l, url: s } = d(a, o, u),
          f = s.pathname + s.search,
          m = {
            replace: u.replace,
            formData: l,
            formMethod: i,
        ...
        e
          ? (null == t && n.invariant(!1), r.fetch(e, t, f, m))
          : r.navigate(f, m);
      },
      [o, r, e, t],
    );
  ...
  function E(e, t) {
    let { relative: o } = void 0 === t ? {} : t,
      { basename: i } = a.useContext(r.UNSAFE_NavigationContext),
      c = a.useContext(r.UNSAFE_RouteContext);
    c || n.invariant(!1);
    let [l] = c.matches.slice(-1),
      s = null != e ? e : '.',
      f = u({}, r.useResolvedPath(s, { relative: o })),
      d = r.useLocation();
    if (
      null == e &&
      ((f.search = d.search), (f.hash = d.hash), l.route.index)
    ) {
      let e = new URLSearchParams(f.search);
      e.delete('index'), (f.search = e.toString() ? '?' + e.toString() : '');
    }
    return (
      (e && '.' !== e) ||
        !l.route.index ||
      ...
      '/' !== i &&
        (f.pathname = '/' === f.pathname ? i : n.joinPaths([i, f.pathname])),
      r.createPath(f)
    );
  }
  !(function (e) {
  ...
  let A = 0;
  const C = 'react-router-scroll-positions';
  let N = {};
  Object.defineProperty(e, 'AbortedDeferredError', {
    enumerable: !0,
    get: function () {
    ...
    Object.defineProperty(e, 'UNSAFE_DataStaticRouterContext', {
      enumerable: !0,
      get: function () {
        return r.UNSAFE_DataStaticRouterContext;
      },
    }),
    ...
    Object.defineProperty(e, 'UNSAFE_enhanceManualRouteObjects', {
      enumerable: !0,
      get: function () {
    ...
    (e.BrowserRouter = function (e) {
      let { basename: t, children: o, window: u } = e,
        i = a.useRef();
      null == i.current &&
        (i.current = n.createBrowserHistory({ window: u, v5Compat: !0 }));
      let c = i.current,
        [l, s] = a.useState({ action: c.action, location: c.location });
      return (
        a.useLayoutEffect(() => c.listen(s), [c]),
    ...
    (e.HashRouter = function (e) {
      let { basename: t, children: o, window: u } = e,
        i = a.useRef();
      null == i.current &&
        (i.current = n.createHashHistory({ window: u, v5Compat: !0 }));
      let c = i.current,
        [l, s] = a.useState({ action: c.action, location: c.location });
      return (
        a.useLayoutEffect(() => c.listen(s), [c]),
      ...
      return (
        (function (e) {
          let { getKey: t, storageKey: n } = void 0 === e ? {} : e,
            { router: o } = w(R.UseScrollRestoration),
            { restoreScrollPosition: u, preventScrollReset: i } = O(
          ...
          a.useEffect(
            ...
            (f = a.useCallback(() => {
              if ('idle' === s.state) {
                let e = (t ? t(c, l) : null) || c.key;
                N[e] = window.scrollY;
              }
              sessionStorage.setItem(n || C, JSON.stringify(N)),
                (window.history.scrollRestoration = 'auto');
            }, [n, t, s.state, c, l])),
            a.useEffect(
              () => (
            ...
            a.useLayoutEffect(() => {
              try {
                let e = sessionStorage.getItem(n || C);
                e && (N = JSON.parse(e));
              } catch (e) {}
            }, [n]),
            a.useLayoutEffect(() => {
              let e =
                null == o
                  ? void 0
                  : o.enableScrollRestoration(N, () => window.scrollY, t);
              return () => e && e();
            }, [o, t]),
            a.useLayoutEffect(() => {
              if (!1 !== u)
                if ('number' != typeof u) {
                  if (c.hash) {
                    let e = document.getElementById(c.hash.slice(1));
    ...
    (e.createBrowserRouter = function (e, t) {
      ...
      return n
        .createRouter({
          ...
          history: n.createBrowserHistory({
            window: null == t ? void 0 : t.window,
          }),
          hydrationData:
            (null == t ? void 0 : t.hydrationData) ||
            (null == (o = window) ? void 0 : o.__staticRouterHydrationData),
          routes: r.UNSAFE_enhanceManualRouteObjects(e),
        })
        .initialize();
    }),
    ...
    (e.unstable_HistoryRouter = function (e) {
      let { basename: t, children: n, history: o } = e;
      const [u, i] = a.useState({ action: o.action, location: o.location });
      return (
        a.useLayoutEffect(() => o.listen(i), [o]),
        a.createElement(r.Router, {
          basename: t,
          children: n,
          location: u.location,
    ...
    (e.useFetcher = function () {
      var e;
      let { router: t } = w(R.UseFetcher),
        o = a.useContext(r.UNSAFE_RouteContext);
      o || n.invariant(!1);
      let i =
        null == (e = o.matches[o.matches.length - 1]) ? void 0 : e.route.id;
      null == i && n.invariant(!1);
      let [c] = a.useState(() => String(++A)),
        [l] = a.useState(
          () => (
            i || n.invariant(!1),
            (function (e, t) {
              return a.forwardRef((r, n) =>
                a.createElement(
                  v,
                  u({}, r, { ref: n, fetcherKey: e, routeId: t }),
                ),
              );
            })(c, i)
          ),
        ...
        [s] = a.useState(() => (e) => {
          t || n.invariant(!1), i || n.invariant(!1), t.fetch(c, i, e);
        }),
        f = S(c, i),
        d = t.getFetcher(c),
        m = a.useMemo(
          () => u({ Form: l, submit: f, load: s }, d),
          [d, l, f, s],
        );
      return (
        a.useEffect(
    ...
    (e.useSearchParams = function (e) {
      let t = a.useRef(f(e)),
        ...
        i = a.useCallback(
          (e, t) => {
            const r = f('function' == typeof e ? e(o) : e);
            u('?' + r, t);
          },
          [u, o],
        );
